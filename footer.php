...
<footer itemscope itemtype="http://schema.org/WPFooter" id="footer" role="contentinfo" class = "footer grey-bg">
	<div class="container">
		<div class="footer-bottom-wrap" style="text-align: left;"> 
			<div id="media_image-4" class="widget widget_media_image" style="margin-bottom:10px;"><img width="220" height="123" src="<?php echo get_template_directory_uri(); ?>/images/logos/Logo EP barra azul.png" class="image wp-image-107  attachment-full size-full" alt="" style="max-width: 100%; height: auto;">
			</div>
		</div>
		<div class="footer-widget-wrap">
			...
			?>
				<div itemscope itemtype="http://schema.org/WPSideBar" role="complementary" id="sidebar-widgets-area-1" class="col-md-4 col-sm-6 col-xs-12 widget-box" aria-label="<?php esc_html_e( 'Widgets Area 1','parallax-one' ); ?>">
					<?php
			...
			?>
				<div itemscope itemtype="http://schema.org/WPSideBar" role="complementary" id="sidebar-widgets-area-2" class="col-md-2 col-sm-6 col-xs-12 widget-box" aria-label="<?php esc_html_e( 'Widgets Area 2','parallax-one' ); ?>">
					<?php
